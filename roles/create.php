                ...
                <div class="card" style="border: 1px solid #606060">
                    ...
                    <div class="card-body">
                     <div class="form-group">
                        <div class="label"><b>Nombre:</b></div>

                        <select class="form-control" name="nombre" id="nombre">
                          <option value="">Seleccionar Rol</option>
                          <option value="ADMINISTRADOR" class="">ADMINISTRADOR</option>
                          <option value="SECRETARIA" class="">SECRETARIA</option>
                          <option value="OPERADOR" class="">OPERADOR</option>
                          <option value="GUARDIA" class="">GUARDIA</option>
                        </select>                        

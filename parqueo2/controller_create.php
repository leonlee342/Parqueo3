...
if ($nro_espacio < "1"){
    // echo "EL NUMERO DE ESPACIO DEBE SER MAYOR A 0";
    ?>
    <div class="alert alert-danger">
        EL NUMERO DE ESPACIO DEBE SER MAYOR A 0
    </div>
    <?php
    
}else if($nro_espacio > "100"){
    // echo "EL NUMERO DE ESPACIO DEBE SER MENOR O IGUAL A 100";
    ?>
    <div class="alert alert-danger">
        EL NUMERO DE ESPACIO DEBE SER MENOR O IGUAL A 100
    </div>
    <?php
        ...
        $contador_espacio = 0;
        $query_espacios = $pdo->prepare("SELECT * FROM tb_mapeos2 WHERE nro_espacio = '$nro_espacio' AND estado = '1' ");
        ...
        if($contador_espacio == "0"){
            ...
            $contador_espacio2 = 0;
            $query_espacios2 = $pdo->prepare("SELECT * FROM tb_mapeos2 WHERE id_map = '$nro_espacio' AND estado = '0' ");
            ...
            if($contador_espacio2 == "0"){
                ...
                //EL ESPACIO ES NUEVO
                $sentencia = $pdo->prepare("INSERT INTO tb_mapeos2

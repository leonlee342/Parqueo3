...
//RESCACAR LA INFORMACION DE LA FACTURA
/* $query_facturas = $pdo->prepare("SELECT * FROM tb_registro WHERE estado = '1'  AND id_registro = '$id_registro'");
$query_facturas->execute();
$facturas = $query_facturas->fetchAll(PDO::FETCH_ASSOC);
    foreach($facturas as $factura){
      $id_registro = $factura['id_registro']; 

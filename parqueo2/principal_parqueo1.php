...
<!DOCTYPE html>
  ...
  <div class="content-wrapper">
        <div class="container">
            <br>
            <h2>Bienvenido al parqueo Nro. 2 - FCYT</h2>
            <br>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Mapeo actual del parqueo Nro2</h3>
                                                                        ...
                                                                        if(placa == ""){
                                                                            ...
                                                                            $('#placa_buscar<?php echo $id_map;?>').focus();                                                                      
                                                                               ...
                                                                               //alert ('listo');
                                                                                ...
                                                                                //REGISTRAR CLIENTES QUE PASAN DE ESTADO DIPONIBLE
                                                                     ...
                                                                     $('#btn_registrar_ticket<?php echo $id_map;?>').click(function(){
                                                                      ...
                                                                      /*       if(placa == ""){
                                                                            ...
                                                                            var url_3 = '../tickets/controller_registrar_ticket.php';
                                                                                $.get(url_3, {placa:placa, nombre_cliente:nombre_cliente, nit_ci:nit_ci,fecha_ingreso:fecha_ingreso, hora_ingreso:hora_ingreso, cuviculo:cuviculo, user_sesion:user_sesion, parqueo_nro:parqueo_nro}, function(datos){
                                                                                $('#respuesta_ticket<?php echo $id_map;?>').html(datos);
                                                                                });    
                                                    ...
                                                    <h2><?php echo $nro_espacio;?></h2>
                                                        ...
                                                        <div class="modal-dialog">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="../tickets/controller_cancelar_ticket2.php?id=<?php echo $id_ticket;?>&&cuviculo=<?php echo $cuviculo;?>" class="btn btn-danger">Cancelar Entrada</a>
                                                                <a href="../tickets2/reimprimir_ticket.php?id=<?php echo $id_ticket;?>" class="btn btn-primary">Volver a Imprimir</a>

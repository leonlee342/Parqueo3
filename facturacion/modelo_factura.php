...
$pdf->setAuthor('Sistema de parqueo FCYT');
$pdf->setTitle('Sistema de parqueo FCYT');
$pdf->setSubject('Sistema de parqueo FCYT');
...
<div>
    <p style="text-align: center">
        ...
        <div style="text-align: left">
            ...
            <b>SEÑOR(A):</b> EDDY CONDORI GUZMAN <br>
        ...
        <br>
        ---------------------------------------------------------------------------------<br>
        <b>USUARIO:</b> EDDY CONDORI GUZMAN

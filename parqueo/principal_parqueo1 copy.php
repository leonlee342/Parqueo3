...
<!DOCTYPE html>
  ...
  <div class="content-wrapper">
        <div class="container">
            <br>
            <h2>Bienvenido al parqueo 1 - FCYT</h2>
            <br>
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Mapeo actual del parqueo 1</h3>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <form>
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-sm-6">
                                                                         <input type="text" class="form-control" id="placa_buscar<?php echo $id_map;?>">
                                                                    </div>
                                                                    <div class="col-sm-3">
...
<!-- 
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <button type="button" class="btn btn-primary" id="btn_registrar_ticket<?php echo $id_map;?>">Registrar Ingreso</button>
                                                                        ...
                                                                        var user_sesion = "<?php echo $usuario_sesion ?>"
                                                                            ...
                                                                            var url_1 = 'controller_cambiar_estado_ocupado.php';
                                                                                ...
                                                                                $('#respuesta_ticket<?php echo $id_map;?>').html(datos);
                                                                                 ...
                                                                                 //REGISTRA EN LA TABLA DOCENTES VEHICULOS EXTERNOS A LA UNIVERSIDAD
                                                                                var url_2 = '../docentes/controller_registrar_clientes.php';
